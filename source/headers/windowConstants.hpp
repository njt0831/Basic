...
const unsigned long FRAME_COLOR = 0x363333;
const unsigned long FRAME_BORDER_COLOR = 0x363333;
const unsigned long BUTTON_BACKGROUND_COLOR = 0x181616;
const int FRAME_BUTTON_WIDTH = 20;
